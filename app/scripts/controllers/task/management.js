...
angular.module('ocspApp')
  .controller('TaskManagementCtrl', ['$scope', '$http', 'Notification', '$q', '$rootScope', '$ngConfirm',
    '$uibModal', '$interval', '$filter', '$location', 'moment', 'CONFIGS', 'NgTableParams', 'globalDataService',
    function ($scope, $http, Notification, $q, $rootScope, $ngConfirm,
      $uibModal, $interval, $filter, moment, CONFIGS, $location, NgTableParams, globalDataService) {
      $rootScope.init('task');
      //i18n
